    ...
    <div className="min-h-screen flex items-center justify-center p-4 bg-gray-50">
      <div className="rounded-sm shadow-2xl overflow-hidden max-w-lg w-full bg-white">
        <div className="w-full p-8 md:p-10 flex flex-col justify-center text-gray-800">
          ...
          <h2 className="text-xl md:text-2xl font-serif text-center font-bold tracking-wide">
            Create an Account
          </h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-8">
              ...
              <div>
                ...
                <select
                  ...
                  value={formData.role}
                  onChange={handleChange}
                  className="w-full px-4 py-2.5 border border-gray-300 rounded-sm focus:outline-none focus:ring-1 focus:ring-black focus:border-black transition-colors bg-white"
                  required
                >
              ...
              {/* Branch Input */}
              <div>
                <label className="block text-sm font-bold text-gray-700 mb-2" htmlFor="branch">
